<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"D:\www\edu\public/../application/index\view\grade\grade_list.html";i:1512313869;s:60:"D:\www\edu\public/../application/index\view\public\base.html";i:1511557853;s:60:"D:\www\edu\public/../application/index\view\public\meta.html";i:1511474915;s:62:"D:\www\edu\public/../application/index\view\public\header.html";i:1511667001;s:60:"D:\www\edu\public/../application/index\view\public\menu.html";i:1512397564;s:62:"D:\www\edu\public/../application/index\view\public\footer.html";i:1511474745;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
					...
					<a href="javascript:;" onclick="member_add('添加班级','<?php echo url("grade/gradeAdd"); ?>','','510')" class="btn btn-primary radius">
						<i class="Hui-iconfont">&#xe600;</i>
						添加班级
                    </a>
				</span>
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="td-status">
                            ...
                            <?php if($vo['status'] == '已开课'): ?>
                            <span class="label label-success radius">已开课</span>
                            <?php else: ?>
                            <span class="label radius">已停课</span>
                            <?php endif; ?>
                        ...
                        <td class="td-manage">
                            ...
                            <?php else: ?>
                            <a style="text-decoration:none" onClick="member_start(this,'<?php echo $vo['id']; ?>')" href="javascript:;" title="停用">
                                <i class="Hui-iconfont">&#xe615;</i>
                            </a>
                            <?php endif; ?>
                            <a title="编辑" href="javascript:;" onclick="member_edit('班级编辑','<?php echo url("grade/gradeEdit",["id"=>$vo["id"]]); ?>','','510')" class="ml-5" style="text-decoration:none">
                            <i class="Hui-iconfont">&#xe6df;</i>
                            </a>
...
<script type="text/javascript">
    ...
    function member_del(obj,id) {
        //请求服务器脚本处理删除
        $.get("<?php echo url('grade/deleteGrade'); ?>", {id: id});
