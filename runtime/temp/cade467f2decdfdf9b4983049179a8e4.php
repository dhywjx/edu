<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\www\edu\public/../application/index\view\user\login.html";i:1528876642;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
	...
	<link rel="stylesheet" type="text/css" href="__STATIC__/static/h-ui/css/H-ui.login.css" />
...
<div class="footer">Copyright 王晶旭 by H-ui.admin.page.v3.0</div>
    ...
    $(function(){
		...
		$("#login").on('click',function (event) {
			$.ajax({
				...
				data:$("form").serialize(),//将当期表单的数据序列号以后再提交
				dataType:'json',//设置提交数据类型 只有返回标志位为1，才进行处理
